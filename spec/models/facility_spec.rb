...
describe Facility do
	...
	describe 'when gym is not present' do
		before { @facility.gym = nil }
		it { should_not be_valid }
	end

	describe 'when lift is not present' do
		before { @facility.lift = nil }
		it { should_not be_valid }
	end

	describe 'when swimming_pool is not present ' do
		before { @facility.swimming_pool = nil }
		it { should_not be_valid }
	end
	...
	describe 'when gym is invalid' do
		describe 'when gym is not present ' do 
			before { @facility.gym = nil }
			it { should_not be_valid }
		end
	...
	describe 'when lift is not valid ' do
		describe 'when lift is not present ' do
			before { @facility.lift = nil }
			it { should_not be_valid }
		end
	...
	describe 'when swimming_pool is not valid ' do
		describe 'when swimming_pool is not present ' do
			before { @facility.swimming_pool = nil }
			it { should_not be_valid }
		end
