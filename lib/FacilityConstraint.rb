...
class FacilityConstraint < BasicConstraint
	...
	cattr_reader :parking_types, :LABEL_PARKING, :LABEL_GYM, :LABEL_SWIMMING_POOL, :LABEL_LIFT,
				 :LABEL_AC, :LABEL_SUBMIT_BUTTON, :PAGE_TITLE
	#parking types
	...
	@@PAGE_TITLE	= "Describe Facilities"
